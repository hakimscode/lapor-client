...
const DetailLaporan = React.lazy(() =>
  import("./views/Data/Laporan/DetailLaporan")
);
const JenisLaporan = React.lazy(() =>
  import("./views/Data/JenisLaporan/JenisLaporan")
);
